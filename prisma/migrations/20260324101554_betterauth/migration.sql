...
*/
-- Clear existing user-linked data to allow schema migration
-- (Development data reset: User model is replaced by BetterAuth)
...
-- AlterTable
ALTER TABLE "GameState" ALTER COLUMN "userId" SET DATA TYPE TEXT;
