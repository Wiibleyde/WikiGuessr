    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center bg-stone-50 px-6">
            <div className="text-center max-w-md mx-auto">
                ...
                <div className="bg-red-50 border border-red-100 rounded-xl px-5 py-4 mb-8 text-left">
                    <p className="text-red-500 font-mono text-xs break-all leading-relaxed">
                ...
                <div className="flex items-center justify-center gap-3 flex-wrap">
                    ...
                    <Link
                        href="/"
                        className="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold px-6 py-3 rounded-xl transition-colors shadow-lg shadow-emerald-100"
                    >
                        ← Retour à l&apos;accueil
                    </Link>
                </div>
